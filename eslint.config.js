        ...
        'error',
        {
          ...
          policies: [
            { from: { element: { types: 'core' } }, allow: { to: { element: { types: 'core' } } } },
            {
              ...
              allow: { to: { element: { types: ['ui', 'core', 'i18n', 'analytics', 'styles'] } } },
            },
            { from: { element: { types: 'i18n' } }, allow: { to: { element: { types: ['i18n', 'core'] } } } },
            {
            ...
            },
            {
              ...
              allow: {
                to: { element: { types: ['pages', 'core', 'ui', 'i18n', 'analytics', 'styles'] } },
              },
            },
            ...
            {
              from: { element: { types: ['ui', 'i18n', 'analytics', 'pages', 'styles'] } },
  ...
  // Pureza de src/core: candado independiente de boundaries (docs/01 §2 y §4).
  {
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              regex: '^[^.]',
              message: 'src/core solo importa rutas relativas dentro de core (cero dependencias).',
            },
          ],
        },
      ],
      'no-restricted-globals': [
        'error',
        { name: 'Date', message: 'El motor no usa Date: el tiempo es "mes 1..N" relativo (docs/01 §2).' },
      ...
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              regex: '^(?!vitest$)[^.]',
              message: 'Los tests de core solo importan vitest y rutas relativas de core.',
            },
          ],
        },
      ],
